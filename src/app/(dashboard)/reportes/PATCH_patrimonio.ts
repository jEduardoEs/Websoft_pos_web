/**
 * INSTRUCCIONES — Agregar reporte de patrimonio a reportes/page.tsx
 *
 * PASO 1: Agregar estado después de los estados existentes (línea ~20):
 *
 *   const [patriLoading, setPatriLoading] = useState(false)
 *
 *
 * PASO 2: Agregar esta función después de exportarPDF():
 */
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .kpi{border:1px solid #e2e8f0;border-radius:6px;padding:10px 12px;border-top:3px solid #2563eb}
...
/**
 * PASO 3: Agregar el botón en el JSX de reportes/page.tsx
 * Busca donde están los otros botones de exportar (cerca de "Exportar PDF")
 * y agrega este botón junto a ellos:
 *
 * <button className="btn-primary" onClick={exportarPatrimonioPDF} disabled={patriLoading}
 *   style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
 *   {patriLoading ? 'Generando...' : 'Reporte de Patrimonio PDF'}
 * </button>
 *
 * O si prefieres un tab separado, agrégalo como una nueva opción en tabReporte:
 *   <button ... onClick={() => setTabReporte('patrimonio')}>Patrimonio</button>
 */
