...
import ZonasInstalacionTab from './ZonasInstalacionTab'
...
export default function ConfiguracionModule() {
  const { cfg, loading, saved, asignando, resultadoAsignacion, setConfigValue: set, saveConfiguracion: save, asignarCodigos } = useConfiguracion();
